---
title: "Multi-buffering"
description: "Overlap computation with DMA using dma.any, swap, and rotate."
order: 7
---

# Multi-Buffering Optimization with Croktile
...
In Croktile, this method requires two key programming primitives: the 'dummy' future **dma.any**, and the **swap/rotate** function. Let's illustrate by an example:
